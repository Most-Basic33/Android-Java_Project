package com.example.bishopwalker.shopping_cart.Sample;
...
public class DataProvider {
    public static final List<Product> dataItemList;
    private static final Map<String, Product> dataItemMap;
private static final List<Product> shoppingList;
    static {
        dataItemList = new ArrayList<>();
        dataItemMap = new HashMap<>();
shoppingList=new ArrayList<>();

        addItem(new Product(null, "Quinoa Salmon Salad", "Salads",
        ...
        addItem(new Product(null, "Chef's Salad", "Salads",
        ...
        addItem(new Product(null, "House Salad", "Salads",
        ...
        addItem(new Product(null, "Garden Buffet", "Salads",
                "Choose from our fresh local, organically grown ingredients to make a custom salad.",
                4, 10, ""));

        addItem(new Product(null, "Mini Cheeseburgers", "Starters",
        ...
        addItem(new Product(null, "Panko Stuffed Mushrooms", "Starters",
        ...
        addItem(new Product(null, "French Onion Soup", "Starters",
        ...
        addItem(new Product(null, "Artichokes with Garlic Aeoli", "Starters",
        ...
        addItem(new Product(null, "Parmesan Deviled Eggs", "Starters",
                "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                        "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
                5, 8, "deviled_eggs.jpg"));

        addItem(new Product(null, "Classic Burger", "Entrees",
        ...
        addItem(new Product(null, "Tomato Bruschetta Tortellini", "Entrees",
        ...
        addItem(new Product(null, "Handcrafted Pizza", "Entrees",
        ...
        addItem(new Product(null, "Barbecued Tofu Skewers", "Entrees",
        ...
        addItem(new Product(null, "Fiesta Family Platter", "Entrees",
        ...
        addItem(new Product(null, "Crème Brûlée", "Desserts",
    ...
    private static void addItem(Product dataItem) {
